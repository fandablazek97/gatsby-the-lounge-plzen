    ...
    <section id="oteviraci-doba" className="relative py-24 md:py-36 lg:py-48">
      ...
      <div className="ui-wrapper" data-wrapper="sm">
        ...
        <div className="mx-auto mt-10 max-w-xl divide-y-1 divide-gray-700">
          ...
          >
            <span className="block">Pondělí</span>
          ...
          <SlideUp
            ...
            className="flex justify-between py-6 font-serif text-lg  font-normal"
          >
            <span className="block">Úterý</span>
            <span className="block">14:00 - 23:00</span>
          </SlideUp>
          <SlideUp
            as="div"
            className="flex justify-between py-6 font-serif text-lg  font-normal"
          >
            <span className="block">Středa</span>
            <span className="block">14:00 - 23:00</span>
          </SlideUp>
          <SlideUp
            as="div"
            className="flex justify-between py-6 font-serif text-lg  font-normal"
          >
            <span className="block">Čtvrtek</span>
            <span className="block">14:00 - 23:00</span>
          </SlideUp>
          <SlideUp
            as="div"
            className="flex justify-between py-6 font-serif text-lg  font-normal"
          >
            <span className="block">Pátek</span>
          ...
          <SlideUp
            ...
            className="flex justify-between py-6 font-serif text-lg  font-normal"
          >
            <span className="block">Sobota</span>
            <span className="block">14:00 - 01:00</span>
          </SlideUp>
          <SlideUp
            as="div"
            className="flex justify-between py-6 font-serif text-lg  font-normal"
          >
            <span className="block">Neděle</span>
